...
<div class="container flex flex-wrap justify-between items-center mx-auto">
  <router-link to='/'>
    <div class="flex items-center">
      <img src="../../assets/logo.svg" class="mr-3 h-6 sm:h-9" alt="The Movie">
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">The Movie</span>
    </div>
  </router-link>
...
<img class="w-8 h-8 rounded-full" src="https://avatars.dicebear.com/api/male/john.svg?mood[]=happy&mood[]=sad" alt="user photo">
</button>
