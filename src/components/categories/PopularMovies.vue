<template>
  <div class="flex flex-col min-h-fit p-5 pb-8 text-gray-800">
      <!-- Component Start -->
	<h1 class="text-lg ml-4 mt-3 uppercase font-bold">Os Mais Populares</h1>
	<div class="flex flex-col sm:flex-row sm:items-end sm:justify-between mt-6">
		<span class="text-sm font-semibold ml-4 text-justify">No brasil hoje</span>
	</div>
...
export default {
    ...
    async mounted(){
        try{
           await this.$http.get('/movie/popular').then(response=>{
